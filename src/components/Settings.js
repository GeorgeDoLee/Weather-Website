        ...
        <div className="row-start-2 col-start-2 justify-self-center self-start mt-30 bg-light-obsidian bg-opacity-50 w-600  rounded-2xl grid grid-rows-3 gap-5 justify-stretch items-center p-5">
            <div className="flex flex-col gap-2 ">
                ...
                <div className="bg-obsidian bg-opacity-65 h-50 grid grid-cols-2 rounded-2xl justify-items-center items-center text-xl">
                    <button className={`${temperature === 'metric' ? 'bg-light-obsidian' : 'hover:bg-light-obsidian hover:bg-opacity-50'} duration-300 rounded-2xl w-250 h-35`} onClick={() => setTemperature('metric')}>Celsius</button>
                    <button className={`${temperature === 'imperial' ? 'bg-light-obsidian' : 'hover:bg-light-obsidian hover:bg-opacity-50'} duration-300 rounded-2xl w-250 h-35`} onClick={() => setTemperature('imperial')}>Fahrenheit</button>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
                <h1>Time Format</h1>
                <div className="bg-obsidian bg-opacity-65 h-50 grid grid-cols-2 rounded-2xl justify-items-center items-center text-xl">
                    <button className={`${time === 24 ? 'bg-light-obsidian' : 'hover:bg-light-obsidian hover:bg-opacity-50'} duration-300 rounded-2xl w-250 h-35`} onClick={() => setTime(24)}>24-hour</button>
                    <button className={`${time === 12 ? 'bg-light-obsidian' : 'hover:bg-light-obsidian hover:bg-opacity-50'} duration-300 rounded-2xl w-250 h-35`} onClick={() => setTime(12)}>12-hour</button>
                </div>
