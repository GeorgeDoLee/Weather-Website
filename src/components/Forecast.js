        ...
        <div className="self-stretch grid grid-rows-2 justify-center items-center  gap-3">
            <div className="self-center">
                <div className="grid grid-cols-2 grid-rows-2 h-250 pl-30">
                    ...
                    <img src={weatherIcons[weather.weather[0].icon]}  alt="icon not found" className="row-span-2 self-center justify-self-center h-320  duration-300 hover:scale-105 cursor-pointer"/>

                   <div className="text-5xl self-end justify-self-start mb-2 ml-2">{weather.main.temp}°</div>
                </div>
            </div>
